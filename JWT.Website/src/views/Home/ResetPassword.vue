<template>
  ...
  >
    <div slot="card-information">
      ...
      >An error has occured, please try again</p>
    </div>
    ...
    methods: {
        submit() {
            ...
            if (this.token) {
                ...
                this.$store.dispatch('authentication/resetPassword', { token: this.token, email: this.email, password: this.password })
                    .then(() => {
                ...
                this.$store.dispatch('authentication/generateResetPasswordEmail', { email: this.email })
                    .then(() => {
                        this.emailSent = true
                    })
                    .catch(() => {
